    ...
    def orderer(self, isbuy):
        ...
        if(isbuy):
            ...
            if(self.live_data and cash > 11.0):
                ...
                speak(Buytext)
                log("Buyed price at:"+str(self.data.close[0])+" || Stoploss price at:"+ str(self.buyprice - (self.buyprice * self.stop_loss/1000)) + " || TP_Sell price at:"+ str(self.buyprice + (self.buyprice * self.bull_takeprofit/1000)))
        else:
