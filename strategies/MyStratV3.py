...
class MyStratV3(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.stop_ar                   =  AverageRage(self.data,period=130,plot=self.plot)
        ...
        self.stop_loss                 =  self.params.p14 * self.stop_ar / 10000
    ...
    def next(self):
        ...
        if(self.isbull):
            ...
            bear_isTakeProfit       = self.data.close[0]   >=  self.buyprice + (self.buyprice * self.bear_takeprofit * self.stop_ar) and not self.buyprice == -1
